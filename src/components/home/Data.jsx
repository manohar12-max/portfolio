  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        As a passionate full-stack developer with a fresh perspective, I bring
        strong skills in both front-end and back-end development. With a keen
        eye for detail and a commitment to clean, efficient code, I enjoy
        building responsive, user-friendly applications. Eager to learn and grow
        in the tech industry, I'm ready to tackle new challenges and contribute
        innovative solutions." 
        Feel free to adjust this to match your specific
